//
//  BrowseLabelsByCountryResultTableViewCell.swift
//  Metal Archives
//
...
final class BrowseLabelsByCountryResultTableViewCell: ThumbnailableTableViewCell, RegisterableCell {
    ...
    func fill(with label: LabelBrowseByCountry) {
